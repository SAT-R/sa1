...
const u8 Tiles_zone_4_act_1_bg[]
    = INCBIN_U8("data/maps/zone_4/act_1/tilemaps/bg/tiles.4bpp");
const u8 Tilemap_zone_4_act_1_bg[]
    = INCBIN_U8("data/maps/zone_4/act_1/tilemaps/bg/tilemap.tilemap2");
