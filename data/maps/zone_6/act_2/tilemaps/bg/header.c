...
const u8 Tiles_zone_6_act_2_bg[]
    = INCBIN_U8("data/maps/zone_6/act_2/tilemaps/bg/tiles.4bpp");
const u8 Tilemap_zone_6_act_2_bg[]
    = INCBIN_U8("data/maps/zone_6/act_2/tilemaps/bg/tilemap.tilemap2");
