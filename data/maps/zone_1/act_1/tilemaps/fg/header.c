...
const s8 CollHeightMap_zone_1_act_1_fg[] = INCBIN_S8("data/maps/zone_1/act_1/tilemaps/fg/height_map.coll");
...
const MetatileIndexType Map_zone_1_act_1_fg0[] = INCBIN_MAP("data/maps/zone_1/act_1/tilemaps/fg/map_front.bin");

const MetatileIndexType Map_zone_1_act_1_fg1[] = INCBIN_MAP("data/maps/zone_1/act_1/tilemaps/fg/map_back.bin");
