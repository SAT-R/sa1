...
const s8 CollHeightMap_zone_7_act_2_fg[] = INCBIN_S8("data/maps/zone_7/act_2/tilemaps/fg/height_map.coll");
...
const MetatileIndexType Map_zone_7_act_2_fg0[] = INCBIN_MAP("data/maps/zone_7/act_2/tilemaps/fg/map_front.bin");

const MetatileIndexType Map_zone_7_act_2_fg1[] = INCBIN_MAP("data/maps/zone_7/act_2/tilemaps/fg/map_back.bin");
