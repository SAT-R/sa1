...
const u16 Map_zone_chao_hunt_act_vs_zone_c_fg0[] = INCBIN_U16("data/maps/chao_hunt/vs_zone_c/tilemaps/fg/map_front.bin");

const u16 Map_zone_chao_hunt_act_vs_zone_c_fg1[] = INCBIN_U16("data/maps/chao_hunt/vs_zone_c/tilemaps/fg/map_back.bin");
