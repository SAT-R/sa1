...
const u8 CollHeightMap_zone_chao_hunt_act_vs_zone_b_fg[] = INCBIN_U8("data/maps/chao_hunt/vs_zone_b/tilemaps/fg/height_map.coll");
...
const u16 Map_zone_chao_hunt_act_vs_zone_b_fg0[] = INCBIN_U16("data/maps/chao_hunt/vs_zone_b/tilemaps/fg/map_front.bin");

const u16 Map_zone_chao_hunt_act_vs_zone_b_fg1[] = INCBIN_U16("data/maps/chao_hunt/vs_zone_b/tilemaps/fg/map_back.bin");

const u8 CollFlags_zone_chao_hunt_act_vs_zone_b_fg[] = INCBIN_U8("data/maps/chao_hunt/vs_zone_b/tilemaps/fg/flags.coll");
...
const Collision CollHeader_zone_chao_hunt_act_vs_zone_b_fg = { CollHeightMap_zone_chao_hunt_act_vs_zone_b_fg,
