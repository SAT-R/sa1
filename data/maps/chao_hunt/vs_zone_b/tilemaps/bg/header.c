...
const u8 Tiles_zone_chao_hunt_act_vs_zone_b_bg[]
    = INCBIN_U8("data/maps/chao_hunt/vs_zone_b/tilemaps/bg/tiles.4bpp");
const u8 Tilemap_zone_chao_hunt_act_vs_zone_b_bg[]
    = INCBIN_U8("data/maps/chao_hunt/vs_zone_b/tilemaps/bg/tilemap.tilemap2");
