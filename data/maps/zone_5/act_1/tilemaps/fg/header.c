...
const u16 Palette_zone_5_act_1_fg[]
    = INCBIN_U16("data/maps/zone_5/act_1/tilemaps/fg/palette.gbapal");
const u8 Tileset_zone_5_act_1_fg[]
    = INCBIN_U8("data/maps/zone_5/act_1/tilemaps/fg/tileset.4bpp");
const u8 CollHeightMap_zone_5_act_1_fg[]
...
const u16 Map_zone_5_act_1_fg0[]
    = INCBIN_U16("data/maps/zone_5/act_1/tilemaps/fg/map_front.bin");

const u16 Map_zone_5_act_1_fg1[]
    = INCBIN_U16("data/maps/zone_5/act_1/tilemaps/fg/map_back.bin");
