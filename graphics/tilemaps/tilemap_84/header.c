...
const u16 Palette_tilemap_84[]
    = INCBIN_U16("graphics/tilemaps/tilemap_84/palette.gbapal");
const u8 Tiles_tilemap_84[] = INCBIN_U8("graphics/tilemaps/tilemap_84/tiles.4bpp");
const u8 Tilemap_tilemap_84[]
    = INCBIN_U8("graphics/tilemaps/tilemap_84/tilemap.tilemap2");
