...
const u8 Tiles_tilemap_75[] = INCBIN_U8("graphics/tilemaps/tilemap_75/tiles.4bpp");
const u8 Tilemap_tilemap_75[] = INCBIN_U8("graphics/tilemaps/tilemap_75/tilemap.tilemap2");
