...
const u8 Tiles_tilemap_73[] = INCBIN_U8("graphics/tilemaps/tilemap_73/tiles.4bpp");
const u8 Tilemap_tilemap_73[] = INCBIN_U8("graphics/tilemaps/tilemap_73/tilemap.tilemap2");
