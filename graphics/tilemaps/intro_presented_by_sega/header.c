...
const u16 Palette_intro_presented_by_sega[]
    = INCBIN_U16("graphics/tilemaps/intro_presented_by_sega/palette.gbapal");
const u8 Tiles_intro_presented_by_sega[]
    = INCBIN_U8("graphics/tilemaps/intro_presented_by_sega/tiles.4bpp");
const u8 Tilemap_intro_presented_by_sega[]
    = INCBIN_U8("graphics/tilemaps/intro_presented_by_sega/tilemap.tilemap2");
