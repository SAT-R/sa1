...
const u8 Tiles_tilemap_74[] = INCBIN_U8("graphics/tilemaps/tilemap_74/tiles.4bpp");
const u8 Tilemap_tilemap_74[] = INCBIN_U8("graphics/tilemaps/tilemap_74/tilemap.tilemap2");
