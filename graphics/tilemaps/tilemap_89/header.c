...
const u16 Palette_tilemap_89[] = INCBIN_U16("graphics/tilemaps/tilemap_89/palette.gbapal");
const u8 Tiles_tilemap_89[] = INCBIN_U8("graphics/tilemaps/tilemap_89/tiles.4bpp");
const u8 Tilemap_tilemap_89[] = INCBIN_U8("graphics/tilemaps/tilemap_89/tilemap.tilemap2");
