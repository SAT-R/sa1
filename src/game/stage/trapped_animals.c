...
const TrappedAnimalData sAnimsTrappedAnimals[NUM_ANIMAL_ZONES][ANIMAL_VARIANTS_PER_ZONE] = {
    [ZONE_1] = {
        { 192, 0x000001BD, 0, ANIMAL_TYPE_STATIC},
        { 196, 0x000001C2, 0, ANIMAL_TYPE_STATIC},
        { 200, 0x000001C1, 0, ANIMAL_TYPE_BOUNCING},
    },
    [ZONE_2] = {
        { 192, 0x000001B9, 0, ANIMAL_TYPE_STATIC},
        { 196, 0x000001BF, 0, ANIMAL_TYPE_BOUNCING},
        { 200, 0x000001C0, 0, ANIMAL_TYPE_FLYING},
    },
    [ZONE_3] = {
        { 192, 0x000001B8, 0, ANIMAL_TYPE_STATIC},
        { 196, 0x000001B7, 0, ANIMAL_TYPE_BOUNCING},
        { 200, 0x000001BA, 0, ANIMAL_TYPE_FLYING},
    }, 
    [ZONE_4] = {
        { 192, 0x000001BD, 0, ANIMAL_TYPE_STATIC},
        { 196, 0x000001B5, 0, ANIMAL_TYPE_STATIC},
        { 200, 0x000001BB, 0, ANIMAL_TYPE_BOUNCING},
    },
    [ZONE_5] = {
        { 192, 0x000001C3, 0, ANIMAL_TYPE_STATIC},
        { 196, 0x000001B8, 0, ANIMAL_TYPE_STATIC},
        { 200, 0x000001B6, 0, ANIMAL_TYPE_BOUNCING},
    },
    [ZONE_6] = {
        { 192, 0x000001B9, 0, ANIMAL_TYPE_STATIC},
        { 196, 0x000001BE, 0, ANIMAL_TYPE_BOUNCING},
        { 200, 0x000001BC, 0, ANIMAL_TYPE_BOUNCING},
    }
};
#elif (GAME == GAME_SA2)
