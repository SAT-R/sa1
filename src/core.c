...
u32 gIntrMainBuf[] = {};
struct Task gTasks[] = {};
u16 sa2__gUnknown_030017F0 ALIGNED(4) = 0;
s16 sa2__gUnknown_030017F4[2] ALIGNED(4) = {};
Background *gBackgroundsCopyQueue[] ALIGNED(16) = {};
u32 gFlags = 0;
u8 sa2__gUnknown_03001850[] ALIGNED(16) = {};
FuncType_030053A0 sa2__gUnknown_03001870[] = {};
...
u8 sa2__gUnknown_03001948 ALIGNED(4) = 0;
...
void EngineInit(void)
{
    ...
    DmaFill32(3, 0, sa2__gUnknown_03002280, sizeof(sa2__gUnknown_03002280));
    ...
    *(u32 *)sa2__gUnknown_03004D80 = 0;
    ...
    sa2__gUnknown_030017F4[0] = 0;
    sa2__gUnknown_030017F4[1] = 0;
    ...
    DmaFill32(3, ~0, sa2__gUnknown_03001850, sizeof(sa2__gUnknown_03001850));
...
void VBlankIntr(void)
{
    ...
    if (gFlagsPreVBlank & FLAGS_40) {
        ...
        REG_DISPSTAT &= 0xff;
        REG_DISPSTAT |= sa2__gUnknown_03002874 << 8;
...
void VCountIntr(void) { REG_IF = INTR_FLAG_VCOUNT; }

void Dma0Intr(void) { REG_IF = INTR_FLAG_DMA0; }

void Dma1Intr(void) { REG_IF = INTR_FLAG_DMA1; }

void Dma2Intr(void) { REG_IF = INTR_FLAG_DMA2; }

void Dma3Intr(void) { REG_IF = INTR_FLAG_DMA3; }

void Timer0Intr(void) { REG_IF = INTR_FLAG_TIMER0; }

void Timer1Intr(void) { REG_IF = INTR_FLAG_TIMER1; }

void Timer2Intr(void) { REG_IF = INTR_FLAG_TIMER2; }

void KeypadIntr(void) { REG_IF = INTR_FLAG_KEYPAD; }

void GamepakIntr(void) { REG_IF = INTR_FLAG_GAMEPAK; }
