...
.endif
	...
	thumb_func_start Task_8038154
Task_8038154: @ 0x08038154
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
_0803838E:
	...
	adds r2, r4, #0
_080383A2:
	ldr r1, _08038400 @ =gMusicManagerState
	movs r0, #0x36
	strb r0, [r1, #1]
	asrs r4, r6, #0x10
	lsls r5, r4, #8
...
sub_8038420: @ 0x08038420
	...
	adds r4, r4, r0
	ldrb r3, [r4]
	ldr r0, _08038544 @ =TaskDestructor_NutsAndBolts
	str r0, [sp]
	mov r0, r8
...
_08038544: .4byte TaskDestructor_NutsAndBolts
...
sub_8038C20: @ 0x08038C20
	...
	movs r2, #0x84
	lsls r2, r2, #6
	ldr r1, _08038CE8 @ =TaskDestructor_803A600
	str r1, [sp]
	movs r1, #0x64
	movs r3, #0
	bl TaskCreate
...
_08038CE8: .4byte TaskDestructor_803A600
...
sub_8038D2C: @ 0x08038D2C
	...
	movs r2, #0x84
	lsls r2, r2, #6
	ldr r1, _08038DF4 @ =TaskDestructor_803A600
	str r1, [sp]
	movs r1, #0x64
	movs r3, #0
	bl TaskCreate
...
_08038DF4: .4byte TaskDestructor_803A600
