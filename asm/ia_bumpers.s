...
_08078E2E:
	cmp r5, #0
	beq _08078E40
	ldr r1, _08078E3C @ =gPartner + 0x59
	movs r0, #0
	ldrsb r0, [r1, r0]
	b _08078E4A
	.align 2, 0
_08078E3C: .4byte gPartner + 0x59
_08078E40:
...
_08078E4A:
	...
	cmp r5, #0
	beq _08078E68
	ldr r2, _08078E64 @ =gPartner + 0x59
	movs r0, #0
	ldrsb r0, [r2, r0]
	cmp r0, #2
	beq _08078E76
...
_08078E76:
	cmp r5, #0
	beq _08078E90
	ldr r3, _08078E8C @ =gPartner + 0x3D
	movs r0, #0
	ldrsb r0, [r3, r0]
	cmp r0, #0
	bne _08078E9E
...
_08078EA6:
	...
	beq _08078EC4
	movs r0, #5
	ldr r1, _08078EC0 @ =gPartner + 0x40
	strb r0, [r1]
	b _08078ECA
	.align 2, 0
_08078EB8: .4byte gPlayer
_08078EBC: .4byte gPartner
_08078EC0: .4byte gPartner + 0x40
_08078EC4:
	movs r0, #5
	ldr r2, _08078EDC @ =gPlayer + 0x40
	strb r0, [r2]
_08078ECA:
	cmp r5, #0
	beq _08078EE0
...
_08079660:
	...
	cmp r3, #0
	beq _08079674
	ldr r1, _08079670 @ =gPartner + 0x59
	movs r0, #0
	ldrsb r0, [r1, r0]
	b _0807967E
	.align 2, 0
_08079670: .4byte gPartner + 0x59
_08079674:
	adds r0, r5, #0
	adds r0, #0x59
	ldrb r0, [r0]
...
_0807967E:
	...
	cmp r2, #0
	beq _08079698
	ldr r3, _08079694 @ =gPartner + 0x59
	movs r0, #0
	ldrsb r0, [r3, r0]
	cmp r0, #2
	beq _080796A6
...
_080796A6:
	...
	cmp r0, #0
	beq _080796BC
	ldr r1, _080796B8 @ =gPartner + 0x3D
	movs r0, #0
	ldrsb r0, [r1, r0]
	cmp r0, #0
	bne _080796CA
...
_080796D4:
	...
	beq _080796F4
	movs r0, #5
	ldr r1, _080796F0 @ =gPartner + 0x40
	strb r0, [r1]
	b _080796FA
	.align 2, 0
_080796E8: .4byte gPlayer
_080796EC: .4byte gPartner
_080796F0: .4byte gPartner + 0x40
_080796F4:
	movs r0, #5
	ldr r2, _08079710 @ =gPlayer + 0x40
	strb r0, [r2]
_080796FA:
...
_08079EF4:
	...
	cmp r1, #0
	beq _08079F10
	ldr r2, _08079F0C @ =gPartner + 0x59
	movs r0, #0
	ldrsb r0, [r2, r0]
	b _08079F16
	.align 2, 0
...
_08079F0C: .4byte gPartner + 0x59
_08079F10:
	ldr r3, _08079F2C @ =gPlayer + 0x59
	movs r0, #0
	ldrsb r0, [r3, r0]
_08079F16:
	cmp r0, #1
	...
	cmp r0, #0
	beq _08079F34
	ldr r1, _08079F30 @ =gPartner + 0x59
	movs r0, #0
	ldrsb r0, [r1, r0]
	cmp r0, #2
	beq _08079F3E
	b _08079F98
	.align 2, 0
_08079F2C: .4byte gPlayer + 0x59
_08079F30: .4byte gPartner + 0x59
_08079F34:
	ldr r2, _08079F50 @ =gPlayer + 0x59
	movs r0, #0
	ldrsb r0, [r2, r0]
	cmp r0, #2
	bne _08079F98
_08079F3E:
	...
	cmp r3, #0
	beq _08079F58
	ldr r1, _08079F54 @ =gPartner + 0x3D
	movs r0, #0
	ldrsb r0, [r1, r0]
	cmp r0, #0
	bne _08079F66
	b _08079F98
	.align 2, 0
_08079F50: .4byte gPlayer + 0x59
_08079F54: .4byte gPartner + 0x3D
_08079F58:
	adds r0, r5, #0
	adds r0, #0x3d
	ldrb r0, [r0]
...
_08079F70:
	...
	beq _08079F90
	movs r0, #5
	ldr r1, _08079F8C @ =gPartner + 0x40
	strb r0, [r1]
	b _08079F96
	.align 2, 0
_08079F84: .4byte gPlayer
_08079F88: .4byte gPartner
_08079F8C: .4byte gPartner + 0x40
_08079F90:
	movs r0, #5
	ldr r2, _08079FAC @ =gPlayer + 0x40
	strb r0, [r2]
_08079F96:
