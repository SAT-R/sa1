...
_08043C8E:
	...
	thumb_func_start sub_8043C98
sub_8043C98: @ 0x08043C98
	push {r4, r5, lr}
	adds r5, r0, #0
	movs r1, #0xc
	ldrsh r0, [r5, r1]
...
_08043D3A:
	...
	thumb_func_start sub_8043D40
sub_8043D40: @ 0x08043D40
	push {r4, r5, lr}
	adds r5, r0, #0
	movs r1, #0xc
	ldrsh r0, [r5, r1]
...
_08043EAE:
	...
	thumb_func_start sub_8043EC0
sub_8043EC0: @ 0x08043EC0
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_08044598:
	...
	thumb_func_start sub_80445A0
sub_80445A0: @ 0x080445A0
	push {r4, r5, r6, r7, lr}
	adds r4, r0, #0
	ldr r0, [r4, #0x30]
	lsls r6, r0, #1
...
_0804466A:
	...
	thumb_func_start sub_8044670
sub_8044670: @ 0x08044670
	push {r4, lr}
	adds r3, r0, #0
	ldr r2, [r3, #0x10]
	movs r0, #0x40
...
_08047084:
	...
	thumb_func_start sub_8047088
sub_8047088: @ 0x08047088
	adds r2, r0, #0
	movs r1, #0xc
	ldrsh r0, [r2, r1]
	cmp r0, #0
...
_080470E4: .4byte gSineTable
	...
	thumb_func_start sub_80470E8
sub_80470E8: @ 0x080470E8
	adds r2, r0, #0
	movs r0, #8
	ldrsh r1, [r2, r0]
	ldr r0, [r2]
...
_08047130:
	...
	thumb_func_start sub_8047134
sub_8047134: @ 0x08047134
	adds r2, r0, #0
	ldr r0, [r2, #0x10]
	movs r1, #0x40
	ands r0, r1
...
_080471D2:
	...
	thumb_func_start sub_80471D4
sub_80471D4: @ 0x080471D4
	push {r4, lr}
	adds r2, r0, #0
	ldr r3, [r2, #0x10]
	movs r0, #0x80
...
_0804726A:
	...
	thumb_func_start sub_804726C
sub_804726C: @ 0x0804726C
	adds r1, r0, #0
	adds r0, #0x3c
	ldrb r0, [r0]
	lsls r0, r0, #0x18
...
_0804727E:
	...
	thumb_func_start sub_8047280
sub_8047280: @ 0x08047280
	adds r0, #0x3c
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
...
_080495EA:
	...
	thumb_func_start sub_80495F0
sub_80495F0: @ 0x080495F0
	push {r4, r5, r6, lr}
	sub sp, #4
	adds r4, r0, #0
	bl sub_804726C
...
_080499BE:
	...
	thumb_func_start sub_80499CC
sub_80499CC: @ 0x080499CC
	push {r4, r5, r6, lr}
	adds r5, r0, #0
...
_08049AAC:
	...
	thumb_func_start sub_8049AB8
sub_8049AB8: @ 0x08049AB8
	push {r4, lr}
	adds r4, r0, #0
	adds r0, #0x3e
	ldrb r0, [r0]
...
_08049E38: .4byte 0xFFFFF800
	...
	thumb_func_start sub_8049E3C
sub_8049E3C: @ 0x08049E3C
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0804A0B4: .4byte sub_803FF84
	...
	thumb_func_start sub_804A0B8
sub_804A0B8: @ 0x0804A0B8
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0804A208: .4byte 0xFFFFCFFF
	...
	thumb_func_start sub_804A20C
sub_804A20C: @ 0x0804A20C
	push {r4, r5, lr}
	ldr r2, [r0, #0x64]
	adds r4, r2, #0
	adds r4, #0xc
...
_0804A250: .4byte gUnknown_084AE1B0
	...
	thumb_func_start sub_804A254
sub_804A254: @ 0x0804A254
	adds r3, r0, #0
	ldrh r2, [r3, #0x38]
	ldr r0, [r3, #0x10]
	movs r1, #0x80
...
_0804C7CC:
	...
	ldr r4, [r0]
	ldr r0, _0804C88C @ =gUnknown_03002320
	ldrb r3, [r0]
	lsls r0, r3, #5
	adds r1, r0, r4
	movs r6, #0x84
...
_0804C88C: .4byte gUnknown_03002320
...
sub_804C9D4: @ 0x0804C9D4
	...
	str r0, [r2, #4]
	ldr r0, _0804CA54 @ =gUnknown_03002320
	ldrb r0, [r0]
	lsrs r0, r0, #1
...
_0804CA54: .4byte gUnknown_03002320
