...
_08000B54:
	...
	cmp r4, r1
	bhs _08000B78
	ldr r6, _08000BF4 @ =sa2__gUnknown_030053A0
	adds r5, r0, #0
_08000B62:
	lsls r0, r4, #2
	adds r0, r0, r6
...
_08000B78:
	...
	mov r1, sp
	str r1, [r2]
	ldr r1, _08000BF4 @ =sa2__gUnknown_030053A0
	str r1, [r2, #4]
...
_08000E70:
	...
	cmp r4, r1
	bhs _08000E94
	ldr r6, _08000EE4 @ =sa2__gUnknown_030053A0
	adds r5, r0, #0
_08000E7E:
	lsls r0, r4, #2
	adds r0, r0, r6
...
_08000E94:
	...
	str r0, [sp, #4]
	add r0, sp, #4
	ldr r5, _08000EE4 @ =sa2__gUnknown_030053A0
