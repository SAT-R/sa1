...
.arm
	...
	thumb_func_start CreateIntroAnimation
CreateIntroAnimation: @ 0x08063918
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
	...
	str r0, [r6, #4]
	ldr r0, _08063B48 @ =0x00000306 @ SA1_ANIM_INTRO_EMERALD
	strh r0, [r6, #0xa]
...
_080639EA:
	...
	adds r0, r1, r2
	str r0, [r6, #4]
	ldr r0, _08063B6C @ =0x00000307 @ This is not Super Sonic, but uses SA1_ANIM_SUPER_SONIC_SPARKLE
	strh r0, [r6, #0xa]
	...
	cmp r7, #7
	bls _080639EA
	ldr r0, _08063B78 @ =Task_80640C8
	movs r2, #0x84
	lsls r2, r2, #6
	ldr r1, _08063B7C @ =TaskDestructor_8065810
	str r1, [sp]
	movs r1, #0x54
	movs r3, #0
	bl TaskCreate
...
_08063B78: .4byte Task_80640C8
_08063B7C: .4byte TaskDestructor_8065810
