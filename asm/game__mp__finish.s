...
@ SA2 func
	thumb_func_start CreateMultiplayerFinishResult
CreateMultiplayerFinishResult: @ 0x08019C14
	push {r4, r5, r6, lr}
	sub sp, #4
	lsls r0, r0, #0x18
	lsrs r4, r0, #0x18
	...
	lsrs r5, r1, #0x18
	movs r6, #0
	ldr r0, _08019C40 @ =sa2__Task_8019E70
	ldr r2, _08019C44 @ =0x00002010
	ldr r1, _08019C48 @ =sa2__TaskDestructor_8019EF4
	str r1, [sp]
	movs r1, #0x34
	movs r3, #0
	bl TaskCreate
	...
	b _08019C58
	.align 2, 0
_08019C40: .4byte sa2__Task_8019E70
_08019C44: .4byte 0x00002010
_08019C48: .4byte sa2__TaskDestructor_8019EF4
...
_08019CE2:
	...
	thumb_func_start sa2__Task_8019E70
sa2__Task_8019E70: @ 0x08019D18
	push {r4, lr}
...
_08019D98: .4byte 0x03000052
	...
	thumb_func_start sa2__TaskDestructor_8019EF4
sa2__TaskDestructor_8019EF4: @ 0x08019D9C
	push {lr}
	ldrh r0, [r0, #6]
	movs r1, #0xc0
	lsls r1, r1, #0x12
