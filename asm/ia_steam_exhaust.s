...
Task_SteamExhaust: @ 0x080891C8
	...
	mov sl, r2
	str r1, [sp, #0x14]
	ldr r4, _08089274 @ =gPartner
	str r5, [sp, #0x10]
	ldr r5, _08089278 @ =gPlayer + 0x27
	subs r5, #0x27
_0808923C:
	ldr r3, _0808927C @ =gPlayer
	cmp r6, #0
	beq _08089244
	ldr r3, _08089274 @ =gPartner
_08089244:
	mov r0, sb
	ldr r1, [sp, #0xc]
	ldr r2, [sp, #0x10]
...
_08089274: .4byte gPartner
_08089278: .4byte gPlayer + 0x27
...
_0808933C:
	...
	cmp r6, #0
	beq _0808934C
	ldr r0, _08089348 @ =gPartner + 0x27
	b _0808934E
	.align 2, 0
_08089348: .4byte gPartner + 0x27
_0808934C:
	ldr r0, _08089370 @ =gPlayer + 0x27
_0808934E:
	ldrb r2, [r0]
	movs r0, #0
	str r0, [sp]
...
_080893AE:
	...
	cmp r6, #0
	beq _080893BC
	ldr r0, _080893B8 @ =gPartner + 0x27
	b _080893BE
	.align 2, 0
_080893B8: .4byte gPartner + 0x27
_080893BC:
	ldr r0, _080893E4 @ =gPlayer + 0x27
_080893BE:
	ldrb r2, [r0]
	movs r0, #0
	str r0, [sp]
...
_080893F2:
	adds r6, #1
	ldr r0, _0808946C @ =gNumSingleplayerCharacters
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r6, r0
...
_0808945A:
	...
	b _080894DE
	.align 2, 0
_0808946C: .4byte gNumSingleplayerCharacters
...
_080896B8:
	...
	cmp r0, #0
	beq _080896CA
	ldr r3, _08089714 @ =gPartner
_080896CA:
	ldr r0, [sp, #8]
	bl sub_80096B0
	movs r1, #1
	add r8, r1
	ldr r0, _08089718 @ =gNumSingleplayerCharacters
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r8, r0
...
_08089714: .4byte gPartner
_08089718: .4byte gNumSingleplayerCharacters
_0808971C:
	ldr r1, [sp, #8]
	adds r1, #0x21
	movs r0, #0xff
...
_080899C0: .4byte gPartner
_080899C4: .4byte gNumSingleplayerCharacters
_080899C8:
	cmp r2, #0x2f
	bgt _080899F2
	ldr r0, [sp, #8]
