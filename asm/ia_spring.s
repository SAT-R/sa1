...
_08021B5A:
	adds r5, #1
	ldr r0, _08021BA4 @ =gNumSingleplayerCharacters
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r5, r0
...
_08021BA4: .4byte gNumSingleplayerCharacters
...
_08021C1A:
	adds r5, #1
	ldr r0, _08021C64 @ =gNumSingleplayerCharacters
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r5, r0
...
_08021C64: .4byte gNumSingleplayerCharacters
...
_08021E0A:
	adds r5, #1
	ldr r0, _08021E54 @ =gNumSingleplayerCharacters
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r5, r0
...
_08021E54: .4byte gNumSingleplayerCharacters
...
_08021ECA:
	adds r5, #1
	ldr r0, _08021F14 @ =gNumSingleplayerCharacters
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r5, r0
...
_08021F14: .4byte gNumSingleplayerCharacters
...
_0802209C:
	adds r4, #1
	ldr r0, _080220EC @ =gNumSingleplayerCharacters
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r4, r0
...
_080220EC: .4byte gNumSingleplayerCharacters
_080220F0:
	adds r0, r5, #0
	bl DisplaySprite
_080220F6:
...
_0802211A:
	...
	bl sub_80228D0
	adds r4, #1
	ldr r0, _08022170 @ =gNumSingleplayerCharacters
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r4, r0
...
_08022170: .4byte gNumSingleplayerCharacters
_08022174:
	adds r0, r5, #0
	bl UpdateSpriteAnimation
	cmp r0, #0
...
_080222F4:
	adds r4, #1
	ldr r0, _08022344 @ =gNumSingleplayerCharacters
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r4, r0
...
_08022344: .4byte gNumSingleplayerCharacters
_08022348:
	adds r0, r5, #0
	bl DisplaySprite
_0802234E:
...
_08022372:
	...
	bl sub_8022AB4
	adds r4, #1
	ldr r0, _080223C8 @ =gNumSingleplayerCharacters
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r4, r0
...
_080223C8: .4byte gNumSingleplayerCharacters
_080223CC:
	adds r0, r5, #0
	bl UpdateSpriteAnimation
	cmp r0, #0
...
_08022534:
	adds r4, #1
	ldr r0, _08022584 @ =gNumSingleplayerCharacters
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r4, r0
...
_08022584: .4byte gNumSingleplayerCharacters
_08022588:
	adds r0, r5, #0
	bl DisplaySprite
_0802258E:
...
_080225B2:
	...
	bl sub_8022E14
	adds r4, #1
	ldr r0, _08022608 @ =gNumSingleplayerCharacters
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r4, r0
...
_08022608: .4byte gNumSingleplayerCharacters
_0802260C:
	adds r0, r5, #0
	bl UpdateSpriteAnimation
	cmp r0, #0
