...
_0807D5EC:
	...
	cmp r5, #0
	beq _0807D5FC
	ldr r4, _0807D5F8 @ =gPartner + 0x27
	ldrb r2, [r4]
	b _0807D600
	.align 2, 0
_0807D5F8: .4byte gPartner + 0x27
_0807D5FC:
	ldr r0, _0807D61C @ =gPlayer + 0x27
	ldrb r2, [r0]
_0807D600:
	movs r4, #0
	str r4, [sp]
	ldr r0, _0807D620 @ =sa2__sub_801ED24
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	bl sa2__sub_801E4E4
	...
	b _0807D626
	.align 2, 0
_0807D61C: .4byte gPlayer + 0x27
_0807D620: .4byte sa2__sub_801ED24
_0807D624:
	ldr r0, [r6]
_0807D626:
	asrs r0, r0, #8
...
_0807D656:
	...
	cmp r5, #0
	beq _0807D664
	ldr r0, _0807D660 @ =gPartner + 0x27
	b _0807D666
	.align 2, 0
_0807D660: .4byte gPartner + 0x27
_0807D664:
	ldr r0, _0807D694 @ =gPlayer + 0x27
_0807D666:
	ldrb r2, [r0]
	movs r0, #0
	str r0, [sp]
	ldr r0, _0807D698 @ =sa2__sub_801ED24
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	bl sa2__sub_801E4E4
...
_0807D684:
	...
	b _0807D782
	.align 2, 0
_0807D694: .4byte gPlayer + 0x27
_0807D698: .4byte sa2__sub_801ED24
_0807D69C:
	ldr r0, [r6]
	adds r0, r0, r1
	b _0807D780
...
_0807D6CC:
	...
	cmp r5, #0
	beq _0807D6DC
	ldr r4, _0807D6D8 @ =gPartner + 0x27
	ldrb r2, [r4]
	b _0807D6E0
	.align 2, 0
_0807D6D8: .4byte gPartner + 0x27
_0807D6DC:
	ldr r0, _0807D6FC @ =gPlayer + 0x27
	ldrb r2, [r0]
_0807D6E0:
	movs r4, #0
	str r4, [sp]
	ldr r0, _0807D700 @ =sa2__sub_801ED24
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	rsbs r3, r3, #0
	...
	b _0807D706
	.align 2, 0
_0807D6FC: .4byte gPlayer + 0x27
_0807D700: .4byte sa2__sub_801ED24
_0807D704:
	ldr r0, [r6]
_0807D706:
	asrs r0, r0, #8
...
_0807D736:
	...
	cmp r5, #0
	beq _0807D744
	ldr r0, _0807D740 @ =gPartner + 0x27
	b _0807D746
	.align 2, 0
_0807D740: .4byte gPartner + 0x27
_0807D744:
	ldr r0, _0807D774 @ =gPlayer + 0x27
_0807D746:
	ldrb r2, [r0]
	movs r0, #0
	str r0, [sp]
	ldr r0, _0807D778 @ =sa2__sub_801ED24
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	rsbs r3, r3, #0
...
_0807D760:
	...
	b _0807D782
	.align 2, 0
_0807D774: .4byte gPlayer + 0x27
_0807D778: .4byte sa2__sub_801ED24
_0807D77C:
	ldr r0, [r6]
	subs r0, r0, r1
_0807D780:
...
_0807D7B8:
	...
	cmp r5, #0
	beq _0807D7C8
	ldr r4, _0807D7C4 @ =gPartner + 0x27
	ldrb r2, [r4]
	b _0807D7CC
	.align 2, 0
_0807D7C4: .4byte gPartner + 0x27
_0807D7C8:
	ldr r0, _0807D7E8 @ =gPlayer + 0x27
	ldrb r2, [r0]
_0807D7CC:
	movs r4, #0
	str r4, [sp]
	ldr r0, _0807D7EC @ =sa2__sub_801EE64
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	rsbs r3, r3, #0
	...
	b _0807D7F2
	.align 2, 0
_0807D7E8: .4byte gPlayer + 0x27
_0807D7EC: .4byte sa2__sub_801EE64
_0807D7F0:
	ldr r0, [r6, #4]
_0807D7F2:
	asrs r1, r0, #8
...
_0807D81E:
	...
	cmp r5, #0
	beq _0807D82C
	ldr r0, _0807D828 @ =gPartner + 0x27
	b _0807D82E
	.align 2, 0
_0807D828: .4byte gPartner + 0x27
_0807D82C:
	ldr r0, _0807D86C @ =gPlayer + 0x27
_0807D82E:
	ldrb r2, [r0]
	movs r0, #0
	str r0, [sp]
	ldr r0, _0807D870 @ =sa2__sub_801EE64
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	rsbs r3, r3, #0
...
_0807D862:
	...
	b _0807D878
	.align 2, 0
_0807D86C: .4byte gPlayer + 0x27
_0807D870: .4byte sa2__sub_801EE64
_0807D874:
	mov r4, sb
	str r4, [r6]
_0807D878:
...
_0807D9D6:
	...
	cmp r5, #0
	beq _0807D9E8
	ldr r4, _0807D9E4 @ =gPartner + 0x27
	ldrb r2, [r4]
	b _0807D9EC
	.align 2, 0
_0807D9E4: .4byte gPartner + 0x27
_0807D9E8:
	ldr r0, _0807DA08 @ =gPlayer + 0x27
	ldrb r2, [r0]
_0807D9EC:
	movs r4, #0
	str r4, [sp]
	ldr r0, _0807DA0C @ =sa2__sub_801EE64
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	rsbs r3, r3, #0
	...
	b _0807DA12
	.align 2, 0
_0807DA08: .4byte gPlayer + 0x27
_0807DA0C: .4byte sa2__sub_801EE64
_0807DA10:
	ldr r0, [r6, #4]
_0807DA12:
	asrs r1, r0, #8
...
_0807DA3E:
	...
	cmp r5, #0
	beq _0807DA4C
	ldr r0, _0807DA48 @ =gPartner + 0x27
	b _0807DA4E
	.align 2, 0
_0807DA48: .4byte gPartner + 0x27
_0807DA4C:
	ldr r0, _0807DA9C @ =gPlayer + 0x27
_0807DA4E:
	ldrb r2, [r0]
	movs r0, #0
	str r0, [sp]
	ldr r0, _0807DAA0 @ =sa2__sub_801EE64
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	rsbs r3, r3, #0
...
_0807DA68:
	...
	b _0807DAA6
	.align 2, 0
_0807DA9C: .4byte gPlayer + 0x27
_0807DAA0: .4byte sa2__sub_801EE64
_0807DAA4:
	str r6, [sp]
_0807DAA6:
	ldr r0, [sp, #0x10]
...
_0807DB5A:
	...
	cmp r5, #0
	beq _0807DB6C
	ldr r0, _0807DB68 @ =gPartner + 0x27
	ldrb r2, [r0]
	b _0807DB70
	.align 2, 0
_0807DB68: .4byte gPartner + 0x27
_0807DB6C:
	ldr r4, _0807DB94 @ =gPlayer + 0x27
	ldrb r2, [r4]
_0807DB70:
	movs r0, #0
	str r0, [sp]
	ldr r0, _0807DB98 @ =sa2__sub_801ED24
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	bl sa2__sub_801E4E4
	...
	b _0807DBA6
	.align 2, 0
_0807DB94: .4byte gPlayer + 0x27
_0807DB98: .4byte sa2__sub_801ED24
_0807DB9C:
	ldr r0, [r6, #0x10]
	movs r1, #0x21
	rsbs r1, r1, #0
...
_0807DC62:
	...
	cmp r5, #0
	beq _0807DC74
	ldr r0, _0807DC70 @ =gPartner + 0x27
	ldrb r2, [r0]
	b _0807DC78
	.align 2, 0
_0807DC70: .4byte gPartner + 0x27
_0807DC74:
	ldr r4, _0807DCA0 @ =gPlayer + 0x27
	ldrb r2, [r4]
_0807DC78:
	movs r0, #0
	str r0, [sp]
	ldr r0, _0807DCA4 @ =sa2__sub_801ED24
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	rsbs r3, r3, #0
	...
	b _0807DCB2
	.align 2, 0
_0807DCA0: .4byte gPlayer + 0x27
_0807DCA4: .4byte sa2__sub_801ED24
_0807DCA8:
	ldr r0, [r6, #0x10]
	movs r1, #0x21
	rsbs r1, r1, #0
...
_0807DDA2:
	...
	cmp r5, #0
	beq _0807DDB4
	ldr r4, _0807DDB0 @ =gPartner + 0x27
	ldrb r2, [r4]
	b _0807DDB8
	.align 2, 0
_0807DDB0: .4byte gPartner + 0x27
_0807DDB4:
	ldr r0, _0807DDD4 @ =gPlayer + 0x27
	ldrb r2, [r0]
_0807DDB8:
	movs r4, #0
	str r4, [sp]
	ldr r0, _0807DDD8 @ =sa2__sub_801EE64
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	bl sa2__sub_801E4E4
	...
	b _0807DDDE
	.align 2, 0
_0807DDD4: .4byte gPlayer + 0x27
_0807DDD8: .4byte sa2__sub_801EE64
_0807DDDC:
	ldr r0, [r6, #4]
_0807DDDE:
	asrs r1, r0, #8
...
_0807DE0A:
	...
	cmp r5, #0
	beq _0807DE18
	ldr r0, _0807DE14 @ =gPartner + 0x27
	b _0807DE1A
	.align 2, 0
_0807DE14: .4byte gPartner + 0x27
_0807DE18:
	ldr r0, _0807DE60 @ =gPlayer + 0x27
_0807DE1A:
	ldrb r2, [r0]
	movs r0, #0
	str r0, [sp]
	ldr r0, _0807DE64 @ =sa2__sub_801EE64
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	bl sa2__sub_801E4E4
...
_0807DE38:
	...
	b _0807E16A
	.align 2, 0
_0807DE60: .4byte gPlayer + 0x27
_0807DE64: .4byte sa2__sub_801EE64
_0807DE68:
	ldr r0, [r6, #4]
	asrs r0, r0, #8
	cmp r1, r0
...
_0807DF0A:
	...
	cmp r5, #0
	beq _0807DF1C
	ldr r4, _0807DF18 @ =gPartner + 0x27
	ldrb r2, [r4]
	b _0807DF20
	.align 2, 0
_0807DF18: .4byte gPartner + 0x27
_0807DF1C:
	ldr r0, _0807DF3C @ =gPlayer + 0x27
	ldrb r2, [r0]
_0807DF20:
	movs r4, #0
	str r4, [sp]
	ldr r0, _0807DF40 @ =sa2__sub_801EE64
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	rsbs r3, r3, #0
	...
	b _0807DF46
	.align 2, 0
_0807DF3C: .4byte gPlayer + 0x27
_0807DF40: .4byte sa2__sub_801EE64
_0807DF44:
	ldr r0, [r6, #4]
_0807DF46:
	asrs r1, r0, #8
...
_0807DF72:
	...
	cmp r5, #0
	beq _0807DF80
	ldr r0, _0807DF7C @ =gPartner + 0x27
	b _0807DF82
	.align 2, 0
_0807DF7C: .4byte gPartner + 0x27
_0807DF80:
	ldr r0, _0807DFC8 @ =gPlayer + 0x27
_0807DF82:
	ldrb r2, [r0]
	movs r0, #0
	str r0, [sp]
	ldr r0, _0807DFCC @ =sa2__sub_801EE64
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r3, #8
	rsbs r3, r3, #0
...
_0807DFA2:
	...
	b _0807E16A
	.align 2, 0
_0807DFC8: .4byte gPlayer + 0x27
_0807DFCC: .4byte sa2__sub_801EE64
_0807DFD0:
	ldr r0, [r6, #4]
	asrs r0, r0, #8
	cmp r1, r0
...
_0807E054:
	cmp r5, #0
	beq _0807E068
	ldr r3, _0807E064 @ =gPartner + 0x40
	movs r0, #0
	ldrsb r0, [r3, r0]
	cmp r0, #0xe
	beq _0807E074
	b _0807E16A
	.align 2, 0
_0807E064: .4byte gPartner + 0x40
_0807E068:
	ldr r4, _0807E088 @ =gPlayer + 0x40
	movs r0, #0
	ldrsb r0, [r4, r0]
	cmp r0, #0xe
	beq _0807E074
...
_0807E0BE:
	cmp r5, #0
	beq _0807E0D4
	ldr r1, _0807E0D0 @ =gPartner + 0x40
	movs r0, #0
	ldrsb r0, [r1, r0]
	cmp r0, #0xe
	beq _0807E0DE
	b _0807E16A
	.align 2, 0
_0807E0D0: .4byte gPartner + 0x40
_0807E0D4:
	ldr r2, _0807E0F0 @ =gPlayer + 0x40
	movs r0, #0
	ldrsb r0, [r2, r0]
	cmp r0, #0xe
	bne _0807E16A
_0807E0DE:
	cmp r5, #0
	beq _0807E0F8
	ldr r3, _0807E0F4 @ =gPartner + 0x59
	movs r0, #0
	ldrsb r0, [r3, r0]
	cmp r0, #3
	bne _0807E102
	b _0807E126
	.align 2, 0
_0807E0F0: .4byte gPlayer + 0x40
_0807E0F4: .4byte gPartner + 0x59
_0807E0F8:
	ldr r4, _0807E10C @ =gPlayer + 0x59
	movs r0, #0
	ldrsb r0, [r4, r0]
	cmp r0, #3
	beq _0807E126
...
_0807E13C:
	movs r0, #4
	ldr r1, _0807E144 @ =gPartner + 0x40
	strb r0, [r1]
	b _0807E16A
	.align 2, 0
_0807E144: .4byte gPartner + 0x40
_0807E148:
	movs r0, #4
	ldr r2, _0807E150 @ =gPlayer + 0x40
	strb r0, [r2]
	b _0807E16A
	.align 2, 0
_0807E150: .4byte gPlayer + 0x40
_0807E154:
	cmp r5, #0
	beq _0807E164
_0807E158:
	movs r0, #5
	ldr r3, _0807E160 @ =gPartner + 0x40
	strb r0, [r3]
	b _0807E16A
	.align 2, 0
_0807E160: .4byte gPartner + 0x40
_0807E164:
	movs r0, #5
	ldr r4, _0807E178 @ =gPlayer + 0x40
sub_807E168:
	strb r0, [r4]
_0807E16A:
	cmp r5, #0
