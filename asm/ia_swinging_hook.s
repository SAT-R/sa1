...
CreateEntity_SwingingHook: @ 0x0808768C
	...
	lsrs r0, r0, #0x18
	mov r8, r0
	ldr r0, _08087728 @ =Task_SwingingHook
	movs r2, #0x80
	lsls r2, r2, #6
	ldr r1, _0808772C @ =TaskDestructor_SwingingHook
	str r1, [sp]
	movs r1, #0xb8
	movs r3, #0
	bl TaskCreate
	...
	b _0808774E
	.align 2, 0
_08087728: .4byte Task_SwingingHook
_0808772C: .4byte TaskDestructor_SwingingHook
