...
_080943B0:
	...
	b _0809468A
_080943BA:
	ldr r0, _08094420 @ =gPlayer + 0x6D
	cmp r3, #0
	beq _080943C2
	ldr r0, _08094424 @ =gPartner + 0x6D
_080943C2:
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
...
_080943D8:
	...
	b _0809442C
	.align 2, 0
_08094420: .4byte gPlayer + 0x6D
_08094424: .4byte gPartner + 0x6D
_08094428:
	mov r1, sb
	str r0, [r1]
_0809442C:
...
_08094500:
	...
	bne _08094598
_0809450A:
	ldr r0, _08094530 @ =gPlayer + 0x6D
	cmp r3, #0
	beq _08094512
	ldr r0, _08094534 @ =gPartner + 0x6D
_08094512:
	movs r1, #0
	ldrsb r1, [r0, r1]
	ldr r2, [sp, #0x14]
	...
	b _08094546
	.align 2, 0
_08094530: .4byte gPlayer + 0x6D
_08094534: .4byte gPartner + 0x6D
...
_08094566:
	cmp r3, #0
	beq _0809457C
	ldr r5, _08094578 @ =gPartner + 0x26
	ldrb r1, [r5]
	movs r0, #0x7f
	ands r0, r1
	strb r0, [r5]
	b _08094588
	.align 2, 0
_08094578: .4byte gPartner + 0x26
_0809457C:
	ldr r0, _08094594 @ =gPlayer + 0x26
	ldrb r1, [r0]
	movs r0, #0x7f
	ands r0, r1
	ldr r1, _08094594 @ =gPlayer + 0x26
	strb r0, [r1]
_08094588:
	movs r1, #1
	lsls r1, r3
...
_080945F8:
	...
	beq _08094608
	movs r0, #5
	ldr r1, _08094604 @ =gPartner + 0x40
	b _0809460E
	.align 2, 0
_08094604: .4byte gPartner + 0x40
_08094608:
	adds r1, r2, #0
	adds r1, #0x40
	movs r0, #5
...
_080946F2:
	...
	b _08094920
_080946FC:
	ldr r0, _08094738 @ =gPlayer + 0x6D
	cmp r3, #0
	beq _08094704
	ldr r0, _0809473C @ =gPartner + 0x6D
_08094704:
	movs r2, #0
	ldrsb r2, [r0, r2]
	mov r1, sl
...
_0809471C:
	...
	b _08094940
	.align 2, 0
_08094738: .4byte gPlayer + 0x6D
_0809473C: .4byte gPartner + 0x6D
_08094740:
	mov r1, sb
	ldr r0, [r1]
	asrs r0, r0, #8
...
_0809487C:
	...
	beq _0809488C
	movs r0, #5
	ldr r1, _08094888 @ =gPartner + 0x40
	b _08094892
	.align 2, 0
_08094888: .4byte gPartner + 0x40
_0809488C:
	adds r1, r2, #0
	adds r1, #0x40
	movs r0, #5
...
_080948BA:
	...
	ldr r4, [sp, #0x1c]
	strb r1, [r4]
	ldr r1, _08094904 @ =gPlayer + 0x6D
	cmp r3, #0
	beq _080948E0
	ldr r1, _08094908 @ =gPartner + 0x6D
_080948E0:
	ldr r5, [sp, #0x14]
	adds r0, r5, r3
	ldrb r0, [r0]
	...
	cmp r3, #0
	beq _08094910
	ldr r1, _0809490C @ =gPartner + 0x26
	ldrb r0, [r1]
	movs r1, #0x80
	orrs r0, r1
	ldr r2, _0809490C @ =gPartner + 0x26
	strb r0, [r2]
	b _08094940
	.align 2, 0
_080948FC: .4byte gPlayer
_08094900: .4byte gPartner
_08094904: .4byte gPlayer + 0x6D
_08094908: .4byte gPartner + 0x6D
_0809490C: .4byte gPartner + 0x26
_08094910:
	ldr r4, _0809491C @ =gPlayer + 0x26
	ldrb r0, [r4]
	movs r1, #0x80
	orrs r0, r1
	strb r0, [r4]
