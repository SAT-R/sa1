...
CreateEntity_MarbleTrack_Exit: @ 0x080836C8
	...
	lsrs r1, r1, #0x18
	mov sl, r1
	ldr r0, _080837D0 @ =Task_MarbleTrack_Exit
	mov r3, sb
	movs r2, #4
	ldrsb r2, [r3, r2]
	movs r1, #0x84
	...
	lsls r2, r2, #0x10
	lsrs r2, r2, #0x10
	ldr r1, _080837D4 @ =TaskDestructor_MarbleTrack_Exit
	str r1, [sp]
	movs r1, #0x54
	movs r3, #0
	bl TaskCreate
	...
	bx r0
	.align 2, 0
_080837D0: .4byte Task_MarbleTrack_Exit
_080837D4: .4byte TaskDestructor_MarbleTrack_Exit
...
_080837EC: .4byte 0x03000031
	...
	thumb_func_start Task_MarbleTrack_Exit
Task_MarbleTrack_Exit: @ 0x080837F0
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_08083E4E:
	...
	thumb_func_start TaskDestructor_MarbleTrack_Exit
TaskDestructor_MarbleTrack_Exit: @ 0x08083E60
	push {lr}
	ldrh r0, [r0, #6]
	movs r1, #0xc0
	lsls r1, r1, #0x12
