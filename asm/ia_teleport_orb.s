...
_08084BCA:
	...
	beq _08084BD8
	movs r0, #5
	ldr r1, _08084BD4 @ =gPartner + 0x40
	b _08084BDE
	.align 2, 0
_08084BD4: .4byte gPartner + 0x40
_08084BD8:
	adds r1, r2, #0
	adds r1, #0x40
	movs r0, #5
...
_08084C68:
	cmp r5, #0
	beq _08084C7C
	ldr r1, _08084C78 @ =gPartner + 0x3C
	movs r0, #0
	ldrsb r0, [r1, r0]
	b _08084C82
	.align 2, 0
_08084C74: .4byte 0xFFBFFFFF
_08084C78: .4byte gPartner + 0x3C
_08084C7C:
	ldr r2, _08084C98 @ =gPlayer + 0x3C
	movs r0, #0
	ldrsb r0, [r2, r0]
_08084C82:
	cmp r0, #0
...
_08084DFC:
	...
	beq _08084E0C
	movs r0, #5
	ldr r1, _08084E08 @ =gPartner + 0x40
	b _08084E12
	.align 2, 0
_08084E08: .4byte gPartner + 0x40
_08084E0C:
	adds r1, r2, #0
	adds r1, #0x40
	movs r0, #5
